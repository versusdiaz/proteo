...
function listar(){
    tabla=$('#tbllistado').dataTable(
	{
		...
		"ajax":
				{
					url: 'controllers/ordenesO.php?op=listar',
					type : "get",
					dataType : "json",
					error: function(e){
 ...
 function imprimir(idodc, idrequest_temp){
    ...
    formData.append("bdDepartamento",'odc_op'); // NOTA CAMBIAR PARA CADA DPTO
    formData.append("bdReq",'request_op'); // NOTA CAMBIAR PARA CADA DPTO
    $.ajax({
