                ...
                <div class="col-sm-12 col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <i class="fa fa-globe"></i> Requesiciones Operaciones
                        </div>
                        <div class="card-body">
                            <!-- AQUI VA TABLA -->
                            ...
                            <form name="formulario" id="formulario" method="POST">
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <input type="hidden" name="idrequest_op" id="idrequest_op">
...
<script type="text/javascript" src="vistas/js/request_op.js"></script>
<?php ob_end_flush(); ?>