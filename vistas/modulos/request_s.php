...
<main class="main">
    ...
    <div class="animated fadeIn">
        <div class="row">
            <div class="col-sm-6 col-xl-6">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-globe"></i> Request Servicios
                        ...
                        <form name="formulario" id="formulario" method="POST">
                            <div class="row">
                                <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="hidden" name="idrequestS_temp" id="idrequestS_temp">
            ...
            <div class="card">
                <div class="card-header">
                    <i class="fa fa-cart-arrow-down"></i> Purchase Servicios
                    ...
                    <form name="formulario" id="formularioP" method="POST">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="detalle" id="detalle" maxlength="40" >
                                </div>
                            </div>
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
...
<script type="text/javascript" src="vistas/js/request_s.js"></script>
<?php ob_end_flush(); ?>